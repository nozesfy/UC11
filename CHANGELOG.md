...
- `alaide/`, `ed/`, `william/` movidos para dentro de `individual/` e removidos da raiz
- `README.md` — paths atualizados para `individual/` e rota do Dashboard corrigida para `/dashboard`
